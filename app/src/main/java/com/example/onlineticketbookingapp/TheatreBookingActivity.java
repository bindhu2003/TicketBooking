...
public class TheatreBookingActivity extends AppCompatActivity {

    private EditText etNumberOfTickets;
    private TextView tvSelectedDate, tvPrice;
    private Button btnSelectDate, btnBookNow;

    private int ticketPrice = 150; // Price per ticket for theatres
    private String selectedDate;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_theatre_booking);
        ...
        btnSelectDate.setOnClickListener(v -> {
            ...
            DatePickerDialog datePickerDialog = new DatePickerDialog(TheatreBookingActivity.this,
        ...
        btnBookNow.setOnClickListener(v -> {
            if (validateInputs()) {
                Intent intent = new Intent(TheatreBookingActivity.this, BookingConfirmationActivity.class);
                intent.putExtra("theatre_name", "Theatre Name"); // Replace with dynamic name
